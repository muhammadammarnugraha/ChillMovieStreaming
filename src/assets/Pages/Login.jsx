...
const Login = () => {
  return (
    <div className="flex justify-center items-center w-screen h-screen bg-center bg-cover bg-[url(C:\Users\AMMAR\harisenin.com\ChillMovieStreaming_React\ChillMovieStreaming\src\assets\Images\loginCinema.jpg)]">
