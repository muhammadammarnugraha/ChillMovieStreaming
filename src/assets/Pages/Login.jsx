  ...
  return (
    ...
    style={{ backgroundImage: `url(${BG})` }}>
      <div className=" p-[24px] lg:p-[40px] flex flex-col justify-center bg-[#181A1CD6]/84 min-w-[306px] min-h-[384px] lg:h-[663px] lg:w-[529px] max-w-[529px] max-h-[663px] rounded-[8px] lg:rounded-[16px] gap-[20px] lg:gap-[37px]">
        <Logo pages="login"/>
        <InputForm pages="login" username={username} setUsername={setUsername} password={password} setPassword={setPassword}/>
        <SubmitForm pages="login" username={username} setUsername={setUsername} password={password} setPassword={setPassword}/>
      </div>
    </div>
  );
};
